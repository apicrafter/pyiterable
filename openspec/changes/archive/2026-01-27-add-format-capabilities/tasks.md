...
## 3. Documentation
- [x] 3.1 Add capability reporting examples to main README
- [x] 3.2 Update API documentation with capability functions
- [x] 3.3 Add capability reporting section to getting started guide
- [x] 3.4 Update capability matrix documentation to reference new API
- [x] 3.5 Add examples showing how to use capabilities programmatically
