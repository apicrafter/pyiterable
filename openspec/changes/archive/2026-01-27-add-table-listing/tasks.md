...
- [x] 7.3 Add tests for `list_tables()` in `test_xls.py` (both class and instance methods)
- [x] 7.4 Add tests for `list_tables()` in `test_ods.py` (both class and instance methods)
- [x] 7.5 Add tests for `list_tables()` in `test_sqlite.py` (both class and instance methods, connection reuse)
- [x] 7.6 Add tests for `list_tables()` in `test_duckdb_format.py` (both class and instance methods, connection reuse)
- [x] 7.7 Add tests for `list_tables()` in `test_hdf5.py` (both class and instance methods)
- [x] 7.8 Add tests for `list_tables()` in `test_netcdf.py` (both class and instance methods)
- [x] 7.9 Add tests for `list_tables()` in `test_geopackage.py` (both class and instance methods)
- [x] 7.10 Add tests for `list_tables()` in `test_rdata.py` (both class and instance methods)
- [x] 7.11 Add tests for formats that don't support tables (should return `None`)
- [x] 7.12 Add tests for `has_tables()` static method across all formats
- [x] 7.13 Add tests for empty files/databases (should return `[]`)
- [x] 7.14 Add tests for edge cases (missing dependencies, invalid files)
