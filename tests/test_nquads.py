...
class TestNQuads:
    ...
    def test_openclose(self):
        ...
        with open(test_file, "w") as f:
            f.write(
                "<http://example.com/subject> <http://example.com/predicate> "
                "<http://example.com/object> <http://example.com/graph> .\n"
            )
    ...
    def test_read_bulk(self):
        ...
        with open(test_file, "w") as f:
            f.write(
                "<http://example.com/subject1> <http://example.com/predicate> "
                "<http://example.com/object1> <http://example.com/graph> .\n"
            )
            f.write(
                "<http://example.com/subject2> <http://example.com/predicate> "
                "<http://example.com/object2> <http://example.com/graph> .\n"
            )
